...
{
    public class BranchRepository : GenericRepository<BranchEntity, BranchDto, BranchForCreationDto>, IBranchRepository
    {
        private DatabaseContext _context;
        private DbSet<BranchEntity> _entity;
        ...
        new public async Task<Guid> CreateAsync(BranchForCreationDto creationDto)
        {
            var newCompany = new BranchEntity();
        ...
        new public async Task<Guid> EditAsync(Guid id, BranchForCreationDto productDto)
        {
