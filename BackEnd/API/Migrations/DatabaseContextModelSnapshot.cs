...
namespace API.Migrations
{
    ...
    partial class DatabaseContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("API.Entities.OrderEntity", b =>
                {
                    ...
                    b.Property<string>("PackageIdList")
                        .IsRequired();
            ...
            modelBuilder.Entity("API.Entities.PackageEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("API.Entities.BranchEntity", b =>
                {
                    b.HasOne("API.Entities.CompanyEntity", "Company")
                        .WithMany("Branchs")
            ...
            modelBuilder.Entity("API.Entities.SellingServiceEntity", b =>
                {
                    b.HasOne("API.Entities.BranchEntity", "Branch")
                        .WithMany()
                    ...
                    b.HasOne("API.Entities.ServiceEntity", "Service")
                        .WithMany()
