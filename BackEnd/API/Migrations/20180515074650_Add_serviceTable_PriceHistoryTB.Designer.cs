...
namespace API.Migrations
{
    ...
    [Migration("20180515074650_Add_serviceTable_PriceHistoryTB")]
    partial class Add_serviceTable_PriceHistoryTB
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("API.Entities.ServiceEntity", b =>
                {
                    ...
                    b.Property<Guid?>("ServiceCatagoryEntityId");

                    b.Property<Guid>("ServiceCatagoryId");

                    b.HasKey("Id");

                    b.HasIndex("ServiceCatagoryEntityId");
            ...
            modelBuilder.Entity("API.Entities.ServiceEntity", b =>
                {
                    b.HasOne("API.Entities.ServiceCatagoryEntity")
                        .WithMany("Services")
                        .HasForeignKey("ServiceCatagoryEntityId");
                });
