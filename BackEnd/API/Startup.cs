...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ISellingServiceRepository, SellingServiceRepository>();
        ...
        private static async Task CreateDefaultRoles(RoleManager<RoleEntity> roleManager)
        {
            ...
            await roleManager.CreateAsync(new RoleEntity("CUSTOMER"));
        }
