...
export class PagesComponent implements OnInit {
  ...
  constructor(
    ...
    translate.get(['dashboard', 'auth', 'login',
      ...
      'accessable_page', 'logout' , 'setting','order_management','order',
    ...
    this.menu = [
      ...
      {
        title: tranlateWords['company_management'],
        icon: 'ion-bag',
        children: [
          {
            title: tranlateWords['company'],
            link: '/pages/company-management/companies',
          },
          {
            title: tranlateWords['branch'],
            link: '/pages/company-management/branchs',
          },
